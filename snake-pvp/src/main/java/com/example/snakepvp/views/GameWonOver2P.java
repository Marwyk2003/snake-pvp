...
public class GameWonOver2P implements Initializable, FxmlView<GameOverViewModel> {
    private Stage stage;
    @InjectViewModel
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        spotlight.getPoints().setAll(0.0, 0.0, 325.0, 0.0, 440.0, 700.0, 0.0, 700.0);
        anchors = new HashMap<>() {{
            ...
            put(coin1, new Double[]{50.0, 0.0, 0.0, 0.0});
            put(coin2, new Double[]{150.0, 0.0, 0.0, 0.0});
            put(coin3, new Double[]{250.0, 0.0, 0.0, 0.0});
            put(trash, new Double[]{0.0, 60.0, 0.0, 0.0});
        }};
